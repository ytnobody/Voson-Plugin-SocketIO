package Voson::Plugin::SocketIO::Assets;
use strict;
use warnings;
...
(function (exports, io) {
  ...
  WS.xdomainCheck = function () {
    re 57 95997   57 55318    0     0  60171      0  0:00:01 --:--:--  0:00:01 67958turn true;
  };
    ...
    if (this.iframe.attachEvent) {
      iframe.onreadystatechange = function () {
        if (self.iframe.readyState == 'complete') {
          complete();
    100 95997  100 95997    0     0  85714      0  0:00:01  0:00:01 --:--:-- 94765
    }
      };
    } else {
